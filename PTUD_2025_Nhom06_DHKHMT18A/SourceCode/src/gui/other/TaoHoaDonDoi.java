...
public class TaoHoaDonDoi {
    ...
    public static void taoHD(ArrayList<Ve> danhSachGhe, HoaDon hd,KhuyenMaiResult kmr,double phidoive) {
        ...
        try {
            ...
            bangThanhToan.addCell(createCell("Phí đổi vé", getFont(12, Font.NORMAL), Element.ALIGN_LEFT));        
            bangThanhToan.addCell(createCell("- "+String.valueOf(phidoive), getFont(12, Font.NORMAL), Element.ALIGN_RIGHT));
