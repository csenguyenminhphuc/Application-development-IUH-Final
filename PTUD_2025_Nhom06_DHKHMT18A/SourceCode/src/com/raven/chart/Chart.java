...
public class Chart extends javax.swing.JPanel {
    ...
    public void setChartMaxValues(double max) {
        blankPlotChart.setMaxValues(max);
    }

    public double getChartMaxValues() {
        return blankPlotChart.getMaxValues();
    }
    ...
    private void initComponents() {
        ...
        blankPlotChart.add(panelLegend);
        panelLegend.setBounds(0, 350, 573, 28);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE))
        );
