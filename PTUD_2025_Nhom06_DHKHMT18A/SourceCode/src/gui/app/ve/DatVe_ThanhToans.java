 ...
 * @author PHAMGIAKHANH
 */
public class DatVe_ThanhToans extends javax.swing.JPanel {
     ...
     */
    public DatVe_ThanhToans() {
        initComponents();
        dv_tt_ihd = new DatVe_ThanhToan_InHoaDon();
        dv_tt_ihd.getButtonInHoaDon().addActionListener(e -> {
            TaoHoaDon.taoHD(listVe, hd, kmr);
            flag = true;
        });
        ...
        dv_tt_ihd.getButtonTroVe().addActionListener(e -> {
            if (flag) {
                cardLayout.show(jPanelChayDatVe, "DAT_VE");
    ...
    public void setjPanelChayDatVe(JPanel jPanelChayDatVe) {
        dv_tt_ihd.setjPanelChayDatVe(jPanelChayDatVe);
        this.jPanelChayDatVe = jPanelChayDatVe;
    }

    public void setCardLayout(CardLayout cardLayout) {
        dv_tt_ihd.setCardLayout(cardLayout);
    ...
    public boolean themHoaDonVaoDB(){
        try {
            ...
            hd.setVAT(0.1);
            hd.setSoVe(listVe.size());
            hd.setTongTien(tongTien);
            //nhanVien = new NhanVien();
            //nhanVien.setMaNV("NV-0-00-853-145");
            hd.setNhanVien(nhanVien);
            KhachHang kh_c = kh_dao.timKhachHangTheoCCCD(khachHang.getCccd());
            if(kh_c != null){
                khachHang = kh_c;
                System.out.println("ma khach hang: "+kh_c.getMaKH() );
            }else{
                String maKH = kh_dao.themKhachHang(khachHang);
            ...
            String mahoadon = hd_dao.themHoaDon(hd,maCa);
    ...
    public void hienThiQRThanhToan(){
        ...
        qrtt.getButtonXNTT().addActionListener(e -> {
            if(themHoaDonVaoDB() && themVeVaoDB()){
                hienThiInHoaDon();
            }else{
    ...
    public void capNhatThongTinHoaDon(){
        ...
        tongTien = thanhTien - kmr.getTienGiam() + tienVAT;
