...
import raven2.chart.blankchart.BlankPlotChart;
import raven2.chart.blankchart.BlankPlotChatRender;
import raven2.spline.Spline;
import raven2.spline.SplinePoint;
...
public class CurveLineChart extends JComponent {
    ...
    private void drawLabel(Graphics2D g2, SplinePoint s) {
        ...
        g2.fill(new Ellipse2D.Double(s.getX() - 10, s.getY() - 10, 20, 20));
        ...
        g2.fill(new Ellipse2D.Double(s.getX() - 2, s.getY() - 2, 4, 4));
        if (selectedIndex >= 0) {
    ...
    private void createPanelLegend() {
        ...
        panelLegend.setLayout(new MigLayout("filly, center, inset 0", "[]10[]20"));
